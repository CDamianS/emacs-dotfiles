...
* Intro
This is a very simple emacs config designed as a way to practice literate programming and elisp, as such it is still missing a lot of configurations and features such as tree-sitter and lsp for it to be a feasible IDE, but it still is a WIP
